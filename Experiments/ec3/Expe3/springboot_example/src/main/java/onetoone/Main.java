...
public class Main {
    ...
    CommandLineRunner initUserData(
        ...
        return args -> {
            ...
            Tutor tutor1 = new Tutor("Math", "Passionate about teaching math", "Ph.D. in Mathematics");
            Tutor tutor2 = new Tutor("Science", "Specialized in physics and chemistry", "M.Sc. in Science Education");
            Tutor tutor3 = new Tutor("physics", "Specialized in physics and chemistry", "M.Sc. in Science Education");
