...
public class loginSuccess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goToHomeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Create an intent to navigate to the "activity_home" page
                Intent intent = new Intent(loginSuccess.this, HomeService.class); // Change to the correct class for "activity_home"
                startActivity(intent);
            }
        });
    }
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            // Parse and process the JSON data from the response
                            // For example, you can display it in a TextView or pass it to another activity
                            String userData = response.toString();
                            Toast.makeText(loginSuccess.this, "User Data: " + userData, Toast.LENGTH_SHORT).show();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(loginSuccess.this, "Error: " + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
